...
class MessageController extends AbstractController
{
     ...
     */
    public function new(Request $request, MessageRepository $messageRepository,DemarchageRepository $demarchageRepository,EntityManagerInterface $entityManager): Response
    {
        $message = new Message();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $demarchageRepository->updateStatus();
            $entityManager->flush();
